...
nts::Components::And4081::And4081() {
...
nts::Tristate nts::Components::And4081::getPinState(size_t outputPinId) {
    switch (outputPinId) {
    case 3:
    case 10:
        return (nts::gates::andGate(getPin(outputPinId - 2).getState(), getPin(outputPinId - 1).getState()));
    ...
    default:
        getPin(outputPinId);
        throw nts::Error("\"4081\" component: pin " + std::to_string(outputPinId) + " is not an output");
    }
}
