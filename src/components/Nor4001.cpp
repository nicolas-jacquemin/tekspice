...
nts::Components::Nor4001::Nor4001() {
...
nts::Tristate nts::Components::Nor4001::getPinState(size_t outputPinId) {
    switch (outputPinId) {
    case 3:
    case 10:
        return (nts::gates::norGate(getPin(outputPinId - 2).getState(), getPin(outputPinId - 1).getState()));
    ...
    default:
        getPin(outputPinId);
        throw nts::Error("\"4001\" component: pin " + std::to_string(outputPinId) + " is not an output");
    }
}
