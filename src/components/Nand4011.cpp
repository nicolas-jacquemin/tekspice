...
nts::Components::Nand4011::Nand4011() {
...
nts::Tristate nts::Components::Nand4011::getPinState(size_t outputPinId) {
    switch (outputPinId) {
    case 3:
    case 10:
        return (nts::gates::nandGate(getPin(outputPinId - 2).getState(), getPin(outputPinId - 1).getState()));
    ...
    default:
        getPin(outputPinId);
        throw nts::Error("\"4011\" component: pin " + std::to_string(outputPinId) + " is not an output");
    }
}
